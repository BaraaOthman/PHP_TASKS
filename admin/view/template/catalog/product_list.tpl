  ...
  <?php } ?></td>
          ...
          <tbody>
            <tr class="filter">
              ...
              <td align="left"><input type="text" name="filter_cost" value="<?php echo $filter_cost; ?>" size="8" placeholder=">= 10" /></td>
              <td align="left"><input type="text" name="filter_profit" value="<?php echo $filter_profit; ?>" size="8" placeholder=">= 10" /></td>
