...
class ControllerCatalogCategory extends Controller
{
	...
	protected function getList()
	{
		...
		if (isset($this->request->get['filter_product_count'])) {
			$url .= '&filter_product_count=' . urlencode(html_entity_decode($this->request->get['filter_product_count'], ENT_QUOTES, 'UTF-8'));
		}
		...
		$this->data['column_parent_path'] = $this->language->get('column_parent_path');
		...
		if (isset($this->request->get['filter_name'])) {
			$url_sort .= '&filter_name=' . urlencode(html_entity_decode($this->request->get['filter_name'], ENT_QUOTES, 'UTF-8'));
		}

		if (isset($this->request->get['filter_product_count'])) {
			$url_sort .= '&filter_product_count=' . urlencode(html_entity_decode($this->request->get['filter_product_count'], ENT_QUOTES, 'UTF-8'));
		}
		...
		$this->data['sort_name'] = $this->url->link('catalog/category', 'token=' . $this->session->data['token'] . '&sort=name' . $url_sort, 'SSL');
		$this->data['sort_sort_order'] = $this->url->link('catalog/category', 'token=' . $this->session->data['token'] . '&sort=c.sort_order' . $url_sort, 'SSL');
		$this->data['sort_product_count'] = $this->url->link('catalog/category', 'token=' . $this->session->data['token'] . '&sort=product_count' . $url_sort, 'SSL');
